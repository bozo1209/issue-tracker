...
class TeamControllerTest {
    ...
    void showTeam() throws Exception {
        ...
        mockMvc.perform(get(TEAM_PATH + "/{teamId}", returnedTeam.getId()))
                .andExpect(status().isOk())
    ...
    void editTeam() throws Exception {
        ...
        mockMvc.perform(get(TEAM_PATH + "/{teamId}/edit", returnedTeam.getId()))
                .andExpect(status().isOk())
                .andExpect(view().name(HTMLPaths.ADD_EDIT_TEAM.getPath()))
    ...
    void processEditingTeam() throws Exception {
        ...
        mockMvc.perform(post(TEAM_PATH + "/{teamId}/edit", returnedTeam.getId()))
                .andExpect(status().is3xxRedirection())
    ...
    void deleteTeam() throws Exception {
        mockMvc.perform(get(TEAM_PATH + "/{teamId}/delete", returnedTeam.getId()))
                .andExpect(status().is3xxRedirection())
